...
namespace SmartSweep3
{
    public sealed class SideScreenPatchMod : UserMod2
    {
        ...
        {
            Debug.Log("[SmartSweep3] OnLoad called");
            base.OnLoad(harmony);
            PUtil.InitLibrary();
    ...
    public static class CustomAutoSweeperLoadGeneratedBuildings
    {
        public static void Prefix()
        {
            Debug.Log("[SmartSweep3] Registering Custom Auto-Sweeper");

            // ✅ Hard-register strings manually
            Strings.Add("STRINGS.BUILDINGS.PREFABS.CUSTOMAUTOSWEEPER.NAME", "SmartSweep3 Auto-Sweeper");
            Strings.Add("STRINGS.BUILDINGS.PREFABS.CUSTOMAUTOSWEEPER.DESC", "A modified Auto-Sweeper with custom settings.");
            Strings.Add("STRINGS.BUILDINGS.PREFABS.CUSTOMAUTOSWEEPER.EFFECT", "Sweeps items based on temperature settings.");

            ModUtil.AddBuildingToPlanScreen("Conveyance", CustomAutoSweeperConfig.ID);
        }
    }
    ...
    public static class DetailsScreen_OnPrefabInit_Patch
    {
        ...
        {
            Debug.Log("[SmartSweep3] Registering AutoSweeper SideScreen");
            PUIUtils.AddSideScreenContent<AutoSweeperSideScreen>();
        }
    }

    public class CustomAutoSweeperConfig : IBuildingConfig
    {
        public const string ID = "CustomAutoSweeper";

        public override BuildingDef CreateBuildingDef()
        {
            Debug.Log("[SmartSweep3] CreateBuildingDef called");
        ...
        {
            Debug.Log("[SmartSweep3] ConfigureBuildingTemplate called");
            go.AddOrGet<Storage>();
        ...
        {
            Debug.Log("[SmartSweep3] DoPostConfigureComplete called");
    ...
    public class AutoSweeperSettings : KMonoBehaviour
    {
        ...
        {
            base.OnSpawn();
            Debug.Log("[SmartSweep3] Spawned with default minTempC=0 and maxTempC=1000");
        }
    }
    ...
    public class AutoSweeperSideScreen : SideScreenContent
    {
        ...
        {
            Debug.Log("[SmartSweep3] Checking if target is valid for side screen");
            return target != null && target.GetComponent<AutoSweeperSettings>() != null;
        }

        public override void SetTarget(GameObject target)
        {
            Debug.Log("[SmartSweep3] Setting side screen target");
        ...
        {
            Debug.Log("[SmartSweep3] Initializing side screen UI");
