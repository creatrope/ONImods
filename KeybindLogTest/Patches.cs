...
namespace KeybindLogTest
{
    ...
    {
        public static void OnF10() => Debug.Log("[KeybindLogTest] CTRL+F10 pressed");
        public static void OnF11() => Debug.Log("[KeybindLogTest] CTRL+F11 pressed");
        public static void OnF12() => Debug.Log("[KeybindLogTest] CTRL+F12 pressed");
    }
    ...
    internal sealed class KeybindHandler : IInputHandler
    {
        ...
        public static void Register(PPatchManager manager)
        {
            ...
            F10Action = actionManager.CreateAction(
                "KeybindLogTest.F10", "Test F10", new PKeyBinding(KKeyCode.F10, Modifier.Ctrl));
            F11Action = actionManager.CreateAction(
                "KeybindLogTest.F11", "Test F11", new PKeyBinding(KKeyCode.F11, Modifier.Ctrl));
            F12Action = actionManager.CreateAction(
                "KeybindLogTest.F12", "Test F12", new PKeyBinding(KKeyCode.F12, Modifier.Ctrl));
        }
    }
